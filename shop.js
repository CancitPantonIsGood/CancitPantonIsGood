$(document).ready(function () {
  ...
  setupTooltip(
    ...
    "#credits-tooltip",
    "Made by: <br> Doctolero, Jhon Christopher <br> Masubay, Mark Joshua <br> Aludo, Cindy Angeline <br> Delcarmen, Aivan <br> All images are credited to ASUS REPUBLIC OF GAMERS and SKT T1"
  );
